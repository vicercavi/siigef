                ...
                <div id="contenidonuevoitem" {if !isset($ejerarquia)}class="collapse"{/if} style="background-color: rgb(251, 250, 250);">
                    ...
                    {if isset($ejerarquia)}
                        <div id="listadecapas" class="span11">
                            <h5>Capa </h5>
                            <div class="span6" >  
                                <h5>Capas Disponibles - <a href="{$_layoutParams.root}mapa/registrarcapa" target="_blank" >Nueva Capa</a></h5>
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            {foreach item=datos from=$capasa}
                                                <tr>
                                                    ...
                                                    <td><a href="{$_layoutParams.root}monitoreo/gestor/edit/{$datos.cap_Idcapa}">Ver Mapa</a></td>
                            ...
                            <table class="table table-hover">
                                ...
                                {foreach item=datos from=$jerarquias}
                                    <tr>
                                        ...
                                        <td><a href="{$_layoutParams.root}monitoreo/gestor/ver/{$datos.jem_IdJerarquiaCapa}">Ver</a></td>
