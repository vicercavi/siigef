...
$(document).on('ready', function() {
    ...
    var paginacion = function(pagina, nombrelista, datos) {
        $.post(_root_ + 'hidrogeo/entidad/_paginacion_' + nombrelista + '/' + datos,
        {
            pagina: pagina,
            palabra:$("#palabra").val()
...
function buscar(palabra) {
    $.post(_root_ + 'hidrogeo/entidad/_buscarEntidad',
            {
                palabra: palabra
            }, function(data) {
        $("#listaregistros").html('');
...
function cambiar_estado(id,estado) {
        ...
        _post = $.post(_root_ + 'hidrogeo/entidad/_cambiarEstadoEntidad',
                {
...
function eliminar(id) {
        ...
        _post = $.post(_root_ + 'hidrogeo/entidad/_eliminarEntidad',
                {
                    pagina: $(".pagination .active span").html(),
                    identidad: id,
                    palabra: $("#palabra").val(),
