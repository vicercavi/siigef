<div  class="container-fluid" >
    <div class="row" style="padding-left: 1.3em; padding-bottom: 20px;">
        <h4 class="titulo-view">{$lenguaje.cuenca_label_titulo}</h4>
    </div>
    {if $_acl->permiso("agregar_cuenca")}
        <div class="panel panel-default">
            <div class="panel-heading jsoftCollap">
                <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed"><i style="float:right"class="fa fa-ellipsis-v"></i><i class="fa fa-user-plus"></i>&nbsp;&nbsp;<strong>{$lenguaje.cuencas_nuevo_titulo}</strong></h3>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 aria-expanded="false" data-toggle="collapse" href="#collapse2" class="panel-title collapsed">
                        ...
                        <strong>{$lenguaje.cuencas_editar_titulo}</strong>
                    </h3>
                </div>
                        ...
                        <div style="width: 90%; margin: 0px auto">                        
                            <form class="form-horizontal" id="form1" role="form" data-toggle="validator" method="post" action="" autocomplete="on">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="nombre" name="nombre" type="text" value="{$datos.Cue_Nombre}" placeholder="{$lenguaje.label_nombre}" required=""/>
                                    </div>
                                </div>
                                <div class="form-group">                                 
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" id="selEstado" name="selEstado">
                                            <option value="0" {if $datos.Cue_Estado == 0}selected="selected"{/if}>Inactivo</option>
                                            <option value="1" {if $datos.Cue_Estado == 1}selected="selected"{/if}>Activo</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;<strong>{$lenguaje.cuencas_buscar_titulo}</strong>                       
                </h3>
            </div>
            <div class="panel-body">                          
                <div class="row">
                    <div class="col-md-12 "> 
                        <div class="col-md-4 pull-right">
                            <div class="input-group">
                                <input id="palabra" type="text" class="form-control"  placeholder="{$lenguaje.text_buscar_cuenca}" name="palabra" />
                ...
                <div style="margin: 15px 25px">
                    <h4 class="panel-title"> <b>{$lenguaje.cuencas_buscar_tabla_titulo}</b></h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Eliminar: <strong class="nombre-es">{$cuenca.Cue_Nombre}</strong></p>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                <a style="cursor:pointer"  id="{$cuenca.Cue_IdCuenca}" data-dismiss="modal" class="btn btn-danger danger eliminar_cuenca">Eliminar</a>
            </div>
        </div>
    </div>
</div>
