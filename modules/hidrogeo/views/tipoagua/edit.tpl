    ...
    {if $_acl->permiso("editar_tipoagua")}
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="glyphicon glyphicon-pencil"></i>&nbsp;&nbsp;<strong>{$lenguaje.tipoaguas_editar_titulo}</strong></h3>
            </div>
                        ...
                        <div style="width: 90%; margin: 0px auto">                        
                            <form class="form-horizontal" id="form1" role="form" data-toggle="validator" method="post" action="" autocomplete="on">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="txtdescripcion" type="text"  name="txtdescripcion" value="{$datos.Tia_Descripcion}" placeholder="{$lenguaje.label_descripcion_editar}"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">{$lenguaje.label_color_editar} : </label>
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="txtcolor" type="text"  name="txtcolor" value="{$datos.color}" placeholder="{$lenguaje.label_color_editar}"/>
                                    </div>
                                </div>
                                <div class="form-group">                                 
