<div  class="container-fluid" >
    ...
    {if $_acl->permiso("agregar_territorio")}
        <div class="panel panel-default">
            <div class="panel-heading jsoftCollap">
                <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed"><i style="float:right"class="fa fa-ellipsis-v"></i><i class="fa fa-user-plus"></i>&nbsp;&nbsp;<strong>{$lenguaje.territorios_nuevo_titulo}</strong></h3>
            </div>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 aria-expanded="false" data-toggle="collapse" href="#collapse2" class="panel-title collapsed">
                        ...
                        <strong>{$lenguaje.territorios_editar_titulo}</strong>
                    </h3>
                </div>
                                ...
                                <form class="form-horizontal" id="form1" role="form" data-toggle="validator" method="post" action="" autocomplete="on">
                                   <div class="form-group">                                 
                                    ...
                                    <div class="form-group">                                 
                                        ...
                                        <div class="col-lg-8">
                                            {if  isset($denominacionesE)}
                                                <select class="form-control" id="selDenominacion" name="selDenominacion" required="">
                                                    <option value="">{$lenguaje.label_seleccion_editar}</option>
                                                    {foreach from=$denominacionesE item=d}
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;<strong>{$lenguaje.territorios_buscar_titulo}</strong>                       
                </h3>
            </div>
            <div class="panel-body">
                ...
                <div style="margin: 15px 25px">
                    <h4 class="panel-title"> <b>{$lenguaje.territorios_buscar_tabla_titulo}</b></h4>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p>Eliminar: <strong class="nombre-es">{$territorio.Ter_Nombre}</strong></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancelar</button>
                <a style="cursor:pointer"  id="{$territorio.Ter_IdTerritorio}" data-dismiss="modal" class="btn btn-danger danger eliminar_territorio">Eliminar</a>
            </div>
        </div>
    </div>
</div>