    ...
    {if $_acl->permiso("editar_entidad")}
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title"><i class="glyphicon glyphicon-pencil"></i>&nbsp;&nbsp;<strong>{$lenguaje.entidades_editar_titulo}</strong></h3>
            </div>
                        ...
                        <div style="width: 90%; margin: 0px auto">                        
                            <form class="form-horizontal" id="form1" role="form" data-toggle="validator" method="post" action="" autocomplete="on">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="nombre" name="nombre" type="text" value="{$datos.Ent_Nombre}" placeholder="{$lenguaje.label_nombre_editar}" required=""/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="siglas" name="siglas" type="text" value="{$datos.Ent_Siglas}" placeholder="{$lenguaje.label_siglas_editar}"/>
                                    </div>
                                </div>
                                <div class="form-group">                                 
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" id="selEstado" name="selEstado">
                                            <option value="0" {if $datos.Ent_Estado == 0}selected="selected"{/if}>Inactivo</option>
                                            <option value="1" {if $datos.Ent_Estado == 1}selected="selected"{/if}>Activo</option>
                                        </select>
