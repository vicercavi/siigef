<div  class="container-fluid" >
    ...
    {if $_acl->permiso("agregar_estadoeca")}
        <div class="panel panel-default">
            <div class="panel-heading jsoftCollap">
                <h3 aria-expanded="false" data-toggle="collapse" href="#collapse3" class="panel-title collapsed"><i style="float:right"class="fa fa-ellipsis-v"></i><i class="fa fa-user-plus"></i>&nbsp;&nbsp;<strong>{$lenguaje.estadoecas_nuevo_titulo}</strong></h3>
            </div>
                        ...
                        <div style="width: 90%; margin: 0px auto">                        
                            <form class="form-horizontal" id="form1" role="form" data-toggle="validator" method="post" action="" autocomplete="on">
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="col-lg-3 control-label">{$lenguaje.label_referencia_nuevo} : </label>
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="referencia" type="text"  name="referencia" value="" placeholder="{$lenguaje.label_referencia_nuevo}" required=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="nombre" type="text"  name="nombre" value="" placeholder="{$lenguaje.label_estado_nuevo}" required=""/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <input class="form-control" id ="color" type="text"  name="color" value="" placeholder="{$lenguaje.label_color_nuevo}" required=""/>
                                    </div>
                                </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">
                    <i class="glyphicon glyphicon-list-alt"></i>&nbsp;&nbsp;<strong>{$lenguaje.estadoecas_buscar_titulo}</strong>                       
                </h3>
            </div>
            <div class="panel-body">                          
                <div class="form-group ">
                ...
                <div style="margin: 15px 25px">
                    <h4 class="panel-title"> <b>{$lenguaje.estadoecas_buscar_tabla_titulo}</b></h4>
