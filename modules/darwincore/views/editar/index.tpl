...
<div class="container-fluid" >
    <div class="row">
        <div class="col-md-12">
            <h3 class="titulo-view">Editor DarwinCore</h3>     
        </div>
        <div class="col-md-3">     
        ...
        <div class="col-md-9">  
            <form data-toggle="validator" class="form-horizontal" role="form"  method="post" id="editarplinian">
      <div class="panel panel-default">
      <div class="panel-heading">
      <h4 class="panel-title"><strong>Editor</strong></h4>
                </div>
                <div class="panel-body">
      <div class="form-group">
        ...
        <div class="col-md-3">
            <div class='input-group date'>
                <input type='text' value="{$datos1.Dar_FechaActualizacion|default:''}" class="form-control" id='Dar_FechaActualizacion' name="Dar_FechaActualizacion" placeholder="dd/mm/yyyy"/> 
            </div>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_CodigoInstitucion|default:''}" class="form-control" id="Dar_CodigoInstitucion" name="Dar_CodigoInstitucion" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">          
          <input type="text" value="{$datos1.Dar_CodigoColeccion|default:''}" class="form-control" id="Dar_CodigoColeccion" name="Dar_CodigoColeccion" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_NumeroCatalogo|default:''}" class="form-control" id="Dar_NumeroCatalogo" name="Dar_NumeroCatalogo" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_NombreCientifico|default:''}" class="form-control" id="Dar_NombreCientifico" name="Dar_NombreCientifico" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_BaseRegistro|default:''}" class="form-control" id="Dar_BaseRegistro" name="Dar_BaseRegistro" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_ReinoOrganismo|default:''}" class="form-control" id="Dar_ReinoOrganismo" name="Dar_ReinoOrganismo" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_Division|default:''}" class="form-control" id="Dar_Division" name="Dar_Division"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_ClaseOrganismo|default:''}" class="form-control" id="Dar_ClaseOrganismo" name="Dar_ClaseOrganismo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_OrdenOrganismo|default:''}" class="form-control" id="Dar_OrdenOrganismo" name="Dar_OrdenOrganismo" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_FamiliaOrganismo|default:''}" class="form-control" id="Dar_FamiliaOrganismo" name="Dar_FamiliaOrganismo" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_GeneroOrganismo|default:''}" class="form-control" id="Dar_GeneroOrganismo" name="Dar_GeneroOrganismo" 
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_EspecieOrganismo|default:''}" class="form-control" id="Dar_EspecieOrganismo" name="Dar_EspecieOrganismo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_SubEspecieOrganismo|default:''}" class="form-control" id="Dar_SubEspecieOrganismo" name="Dar_SubEspecieOrganismo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_AutorNombreCientifico|default:''}" class="form-control" id="Dar_AutorNombreCientifico" name="Dar_AutorNombreCientifico"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_IdentificadoPor|default:''}"  class="form-control" id="Dar_IdentificadoPor" name="Dar_IdentificadoPor"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_AnoIdentificacion|default:''}" class="form-control" id="Dar_AnoIdentificacion" name="Dar_AnoIdentificacion"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text"  value="{$datos1.Dar_MesIdentificacion|default:''}" class="form-control" id="Dar_MesIdentificacion" name="Dar_MesIdentificacion"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_DiaIdentificacion|default:''}" class="form-control" id="Dar_DiaIdentificacion" name="Dar_DiaIdentificacion"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_StatusTipo|default:''}" class="form-control" id="Dar_StatusTipo" name="Dar_StatusTipo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_NumeroColector|default:''}" class="form-control" id="Dar_NumeroColector" name="Dar_NumeroColector"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_NumeroCampo|default:''}" class="form-control" id="Dar_NumeroCampo" name="Dar_NumeroCampo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_Colector|default:''}" class="form-control" id="Dar_Colector" name="Dar_Colector"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_AnoColectado|default:''}" class="form-control" id="Dar_AnoColectado" name="Dar_AnoColectado"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_MesColectado|default:''}" class="form-control" id="Dar_MesColectado" name="Dar_MesColectado"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_DiaColectado|default:''}" class="form-control" id="Dar_DiaColectado" name="Dar_DiaColectado"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_DiaOrdinario|default:''}"  class="form-control" id="Dar_DiaOrdinario" name="Dar_DiaOrdinario"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_HoraColectado|default:''}" class="form-control" id="Dar_HoraColectado" name="Dar_HoraColectado"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_ContinenteOceano|default:''}" class="form-control" id="Dar_ContinenteOceano" name="Dar_ContinenteOceano"
        ...
        <div class="col-md-3">
          <select class="form-control" id="Dar_Pais" name="Dar_Pais">
            ...
            {foreach from=$paises item=ps}
                <option value="{$ps.Pai_Nombre}" {if $ps.Pai_Nombre == TRIM($datos1.Dar_Pais) } selected="selected" {/if}>{$ps.Pai_Nombre}</option>
            {/foreach}
          </select>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_EstadoProvincia|default:''}"  class="form-control" id="Dar_EstadoProvincia" name="Dar_EstadoProvincia"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text"  value="{$datos1.Dar_Municipio|default:''}" class="form-control" id="Dar_Municipio" name="Dar_Municipio"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_Localidad|default:''}" class="form-control" id="Dar_Localidad" name="Dar_Localidad"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text"  value="{$datos1.Dar_Longitud|default:''}" class="form-control" id="Dar_Longitud" name="Dar_Longitud"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_Latitud|default:''}" class="form-control" id="Dar_Latitud" name="Dar_Latitud"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_PrecisionDeCordenada|default:''}" class="form-control" id="Dar_PrecisionDeCordenada" name="Dar_PrecisionDeCordenada"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_BoundingBox|default:''}" class="form-control" id="Dar_BoundingBox" name="Dar_BoundingBox"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text"  value="{$datos1.Dar_MinimaElevacion|default:''}" class="form-control" id="Dar_MinimaElevacion" name="Dar_MinimaElevacion"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_MaximaElevacion|default:''}"  class="form-control" id="Dar_MaximaElevacion" name="Dar_MaximaElevacion"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_MinimaProfundidad|default:''}"  class="form-control" id="Dar_MinimaProfundidad" name="Dar_MinimaProfundidad"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_MaximaProfundidad|default:''}"  class="form-control" id="Dar_MaximaProfundidad" name="Dar_MaximaProfundidad"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_SexoOrganismo|default:''}" class="form-control" id="Dar_SexoOrganismo" name="Dar_SexoOrganismo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_PreparacionTipo|default:''}" class="form-control" id="Dar_PreparacionTipo" name="Dar_PreparacionTipo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_ConteoIndividuo|default:''}" class="form-control" id="Dar_ConteoIndividuo" name="Dar_ConteoIndividuo"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_NumeroCatalogoAnterior|default:''}" class="form-control" id="Dar_NumeroCatalogoAnterior" name="Dar_NumeroCatalogoAnterior"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_TipoRelacion|default:''}" class="form-control" id="Dar_TipoRelacion" name="Dar_TipoRelacion"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_InformacionRelacionada|default:''}"  class="form-control" id="Dar_InformacionRelacionada" name="Dar_InformacionRelacionada"
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          <input type="text" value="{$datos1.Dar_EstadoVida|default:''}" class="form-control" id="Dar_EstadoVida" name="Dar_EstadoVida"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_Nota|default:''}" class="form-control" id="Dar_Nota" name="Dar_Nota"
      ...
      <div class="form-group">
        ...
        <div class="col-md-5">
          <input type="text" value="{$datos1.Dar_NombreComunOrganismo|default:''}" class="form-control" id="Dar_NombreComunOrganismo" name="Dar_NombreComunOrganismo"
                 placeholder="{$ficha[49]['Fie_CampoFicha']}" >
        </div>
      </div>
      <div class="form-group">
        <div class="col-md-offset-4 col-md-5">
          <button type="submit" id="editarDarwin" name="editarDarwin" class="btn btn-primary">Actualizar</button>
