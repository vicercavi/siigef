...
//                $("#correo").val(),$("#usuario").val(),$("#contrasena").val(),$("#confirmarContrasena").val());
    ...
    var paginacion = function(pagina, nombrelista, datos) 
    {
        ...
        _post = $.post(_root_ + 'bdrecursos/_paginacion_' + nombrelista + '/' + datos,
                {
                    pagina: pagina,
                    tipo: _tipo,
    ...
    $("body").on('click', '.estado-recurso', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_actualizarEstado',
                {
    ...
    var filtroRecurso = function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_filtroRecursos',
                {
                    tipo: _tipo,
                    nombre: $("#tb_nombre_filter").val(),
                    estandar: $("#sl_estandar_recurso_filtro").val(),
    ...
    $("body").on('click', '.eliminar_recurso', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarRecurso',
                {
                    pagina: $(".pagination .active span").html(),
                    tipo: _tipo,
                    nombre: $("#tb_nombre_filter").val(),
    ...
    $('body').on('click', '.idioma-recurso', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_getTraduccionRecurso', {
            idIdioma: $(this).val(),
    ...
    $("body").on('click', "#buscar_recurso", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarRecursoEstandar',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
    ...
    $("body").on('click', "#buscarVariable", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarVariableEstandar',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
                    id_recurso:$("#hd_id_recurso").val()
                },
    ...
    $("body").on('click', "#bt_buscar_calidadagua", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarCalidadAgua',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
                    id_recurso:$("#hd_id_recurso").val()
                },
    ...
    $("body").on('click', "#bt_buscar_legislacion", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarLegislacion',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
                    id_recurso:$("#hd_id_recurso").val()
                },
    ...
    $("body").on('click', "#bt_buscar_dublin", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarDublincore',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
                    id_recurso:$("#hd_id_recurso").val()
                },
    ...
    $("body").on('click', "#bt_buscar_plinian", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarPlinianCore',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
                    id_recurso:$("#hd_id_recurso").val()
                },
    ...
    $("body").on('click', "#bt_buscar_darwin", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_buscarDarwinCore',
                {                 
                    nombre: $("#tb_nombre_filter").val(),
                    id_recurso:$("#hd_id_recurso").val()
                },
    ...
    $("body").on('click', ".ce_calidadagua", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_cambiarEstadoCalidadAgua',
                {                 
    ...
    $("body").on('click', ".ce_legislacion", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_cambiarEstadoLegislacion',
                {                 
    ...
    $("body").on('click', ".ce_dublin", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_cambiarEstadoDublin',
                {                 
    ...
    $("body").on('click', ".ce_plinian", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_cambiarEstadoPlinian',
                {                 
    ...
    $("body").on('click', ".ce_darwin", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_cambiarEstadoDarwin',
                {                 
    ...
    $("body").on('click', ".ce_estandar", function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_cambiarEstado',
                {                 
    ...
    $("body").on('click', '.eliminar_calidadagua', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarCalidadAgua',
                {
                    pagina: $(".pagination .active span").html(),
                    id_mca: $(this).attr("id"),
                    nombre: $("#tb_nombre_filter").val(),
    ...
    $("body").on('click', '.eliminar_legislacion', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarLegislacion',
                {
                    pagina: $(".pagination .active span").html(),
    ...
    $("body").on('click', '.eliminar_dublin', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarDublincore',
                {
                    pagina: $(".pagination .active span").html(),
    ...
    $("body").on('click', '.eliminar_plinian', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarPlinian',
                {
                    pagina: $(".pagination .active span").html(),
    ...
    $("body").on('click', '.eliminar_darwin', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarDarwinCore',
                {
                    pagina: $(".pagination .active span").html(),
    ...
    $("body").on('click', '.eliminar_estandar', function() {
        ...
        _post = $.post(_root_ + 'bdrecursos/_eliminarEstandarxRecurso',
                {
                    pagina: $(".pagination .active span").html(),
