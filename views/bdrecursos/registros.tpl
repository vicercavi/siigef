                                    ...
                                    <div class="col-md-4 pull-right">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="bt_buscar_calidadagua" class="btn btn-default" type="button">
                                ...
                                <div class="col-md-12 ">   
                                    <div class="col-md-4 pull-right">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="bt_buscar_dublin" class="btn btn-default" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div>  
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 ">   
                                    <div class="col-md-4 pull-right">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="bt_buscar_plinian" class="btn btn-default" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div>  
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 ">   
                                    <div class="col-md-4 pull-right">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="bt_buscar_darwin" class="btn btn-default" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div>  
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">   
                                    <div class="col-md-4 pull-right">
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button id="bt_buscar_legislacion" class="btn btn-default" type="button"><span class="glyphicon glyphicon-search"></span></button>
                                            </span>
                                        </div>  
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        {foreach item=datos from=$legislacion}
                                            <tr>
                                                ...
                                                <td>{$datos.Mal_FechaPublicacion}</td>
                                                <td style=" text-align: center">
