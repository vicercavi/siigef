        ...
        <div class="panel-body">
            ...
            <div class="tab-content">
                <div id="variable" class="tab-pane active">
                    {if isset($tablaGenerada2) && $tablaGenerada2 == 1}
                                    ...
                                    <div id="nuevoRegistro">
                                        <div style="width: 90%; margin: 0px auto">
                                            <form class="form-horizontal" id="form1" name="form1" role="form" data-toggle="validator" method="post" action="" autocomplete="on">
                                                {if isset($fichaVariable) && count($fichaVariable)}
                                                    {foreach from=$fichaVariable item=fi}
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-8">
                                                                <input type="text" name="{$fi.Pro_Nombre}" class="form-control"/>
                                                            </div>                                            
                                                        </div>
                                                    {/foreach}
                                                {/if}                                                          
                                                <div class="form-group">
                                                    <div class="col-lg-offset-2 col-lg-8">
                                                        <button class="btn btn-success" id="bt_guardarRegistroRecurso" name="bt_guardarRegistroRecurso" type="submit" ><i class="glyphicon glyphicon-floppy-disk"> </i>&nbsp; {$lenguaje.button_ok}</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>        
                                        ...
                                        <div class="table-responsive" >
                                            <table class="table" style=" text-align: center">
                                                <tr>
                                                    ...
                                                    <th style=" text-align: center">{$us.$campo_nombre|truncate:30:"...":true}</th>
                                                    {/foreach}                                                    
                                                    <th style=" text-align: center">Estado</th>
                                                    <th style=" text-align: center">Opciones</th>
                                                </tr>
